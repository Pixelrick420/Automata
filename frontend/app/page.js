...
export default function Home() {
  ...
  const handleSubmit = (e) => {
    ...
    fetch("http://localhost:8000/automaton", {
      method: "POST",
        ...
        {automaton && (
          <>
            <div className="info-card">
              <h4>States</h4>
              <p>{automaton.states.length} total states</p>
            </div>

            <div className="info-card">
              <h4>Initial</h4>
              <p>State q{automaton.initial}</p>
            </div>

            <div className="info-card">
              <h4>Final</h4>
              <p>State q{automaton.final}</p>
            </div>
          </>
        )}
      </div>

      <div className="automata-panel" onWheel={(e) => e.preventDefault()}>
        <AutomataVisualizer
          automaton={automaton}
          positions={positions}
